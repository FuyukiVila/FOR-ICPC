...
public:
    ...
    T range_sum(int l, int r) { return range_sum(l, r, 0, end, root); }//区间求和

    void range_set(int l, int r, int val) { range_set(l, r, val, 0, end, root); }//区间加

    void range_add(int l, int r, int val) { range_add(l, r, val, 0, end, root); } //区间修改
};